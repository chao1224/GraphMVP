...
if __name__ == "__main__":
    ...
    if 'GEOM' in args.dataset:
        dataset = MoleculeDataset_graphcl_complete('../datasets/{}/'.format(args.dataset),
                                                   dataset=args.dataset)
    else:
        dataset = MoleculeDataset_graphcl_complete('../datasets/molecule_datasets_regression/' + args.dataset,
                                                   dataset=args.dataset)
