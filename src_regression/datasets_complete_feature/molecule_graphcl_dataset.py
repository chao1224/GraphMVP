...
class MoleculeDataset_graphcl_complete(MoleculeDatasetComplete):
    ...
    def __init__(self,
        ...
        super(MoleculeDataset_graphcl_complete, self).__init__(
    ...
    def edge_pert(self, data):
        ...
        # check here: https://github.com/snap-stanford/ogb/blob/master/ogb/utils/features.py#L2
        edge_attr_add_1 = torch.tensor(np.random.randint(
            5, size=(edge_index_add.shape[1], 1)))
        edge_attr_add_2 = torch.tensor(np.random.randint(
            6, size=(edge_index_add.shape[1], 1)))
